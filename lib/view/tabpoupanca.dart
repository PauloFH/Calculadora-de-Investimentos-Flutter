...
import 'package:investimentos/view/tabcdb.dart';
...
class TabPoupanca extends StatefulWidget {
  const TabPoupanca({super.key});

  @override
  State<TabPoupanca> createState() => _TabPoupanca();
}

class _TabPoupanca extends State<TabPoupanca> {
  double result = 0;
  @override
  Widget build(BuildContext context) {
    String name = AppLocalizations.of(context)!.savingsAccount;
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text(
                AppLocalizations.of(context)!.titlessavingsAccount,
                style: const TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                ),
            ...
            Container(
              ...
              child: Text(' ${AppLocalizations.of(context)!.brl} \n R\$ ${result.toStringAsFixed(2)}',
                  style: const TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                  ),
